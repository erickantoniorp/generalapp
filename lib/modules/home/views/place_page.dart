    ...
    return Scaffold(
        ...
        body: Column(
          ...
          children: [
                ...
                child: Form(
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        initialValue: (homecont.curTask.value.estado > 0)
                            ? ("Activo")
                            : ("Inactivo"),
                        onChanged: (value) {
                          //controller.setEmail(value);
            ...
            SizedBox(
                width: double.infinity,
                child: Obx(() => (controller.placeList.isEmpty)
                        ...
                        rows: List<DataRow>.generate(
                          ...
                          (index) => DataRow(
                            ...
                            cells: [
                              ...
                              DataCell(
                                Text((controller.placeList[index].verificado)
                                    ? ("Si")
                                    : ("No")),
                              ),
                              DataCell(
                                Text((controller
                                        .placeList[index].fechallegada.isEmpty)
                                    ? ('')
                                    : (controller.placeList[index].fechallegada
                                        .toString())),
                              ),
                              DataCell(
                                Text((controller
                                        .placeList[index].fechatermino.isEmpty)
                                    ? ('')
                                    : (controller.placeList[index].fechatermino
                                        .toString())),
                              ),
                            ],
                          ),
